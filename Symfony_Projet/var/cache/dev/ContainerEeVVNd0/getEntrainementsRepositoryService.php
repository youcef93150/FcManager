 ...
 */
class getEntrainementsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EntrainementsRepository' shared autowired service.
     *
     * @return \App\Repository\EntrainementsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntrainementsRepository.php';

        return $container->privates['App\\Repository\\EntrainementsRepository'] = new \App\Repository\EntrainementsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
